...
int main(int argc, char **argv)
{
  ...
  if (!nh.getParam("output_pose_topic_name", output_pose_topic_name))   {
    ROS_ERROR("Couldn't retrieve the topic name for the output pose topic. ");
    return -1;
  }
