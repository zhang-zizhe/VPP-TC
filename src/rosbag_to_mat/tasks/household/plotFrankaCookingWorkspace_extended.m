function [Objects_APRegions] = plotFrankaCookingWorkspace_extended(H_left_bowl, H_center_bowl, H_right_bowl)
...
%%%%% Draw Left Bowl
P = H_left_bowl(1:3,4)' + [0 0 0.07];
L = [0.21,0.21,0.06 + 0.14];
O = P-L/2 ;       % Get the origin of cube so that P is at center 
...
%%%%% Draw Center Bowl
P = H_center_bowl(1:3,4)' + [0 0 0.10];
L = [0.21,0.21,0.06 + 0.20];
O = P-L/2 ;       % Get the origin of cube so that P is at center 
