...
class FrankaStateController
    : public controller_interface::MultiInterfaceController<franka_hw::FrankaStateInterface, franka_hw::FrankaModelInterface> {
 public:
  /**
 ...
 private:
  ...
  void publishFrankaModels(const ros::Time& time);
  ...
  realtime_tools::RealtimePublisher<std_msgs::Float32MultiArray> publisher_franka_models_;
