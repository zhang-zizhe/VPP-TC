...
def get_args():
    ...
    parser.add_argument("--gamma-threshold", type=float, default=3.9,
    ...
    parser.add_argument("--lc-rotate-speed-left", type=float, default=0.2,
                        help="Left plane rotation speed in rad/s (0=no rotation)")
    parser.add_argument("--lc-rotate-speed-right", type=float, default=0.2,
    ...
    parser.add_argument("--lc-eccentricity", type=float, default=0.6,
