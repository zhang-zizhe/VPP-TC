...
bag_dir = '../../bags/franka-cooking-dec21/';
data_dir = '../../mat/franka-cooking-dec21/';
...
%% Visualize Trajectories on Franka Cooking Workspace!!
close all; 
figure('Color',[1 1 1])
...
Objects_APregions = plotFrankaCookingWorkspace(H_left_bowl, H_center_bowl, H_right_bowl);
...
matfile = strcat(data_dir,'demos_dec2021_raw_data.mat');
