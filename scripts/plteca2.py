...
file_paths = [
    ...
    "../output/1757563807.2642505.csv",
    "../output/1757559826.5177507.csv"
]
labels = ["w/o ECA", "w/ ECA", "w/ ECA2"]
color_map = {"w/o ECA": "tab:orange", "w/ ECA": "tab:green", "w/ ECA2": "tab:blue"}
...
# 保存图像（DPI 可根据需要调整）
plt.savefig("../output/plot_eca2.png", dpi=1300, bbox_inches="tight")
plt.show()
