...
int main(int argc, char **argv)
{
  ...
  if (!nh.getParam("att_all", attractor_all))  {
    ROS_ERROR("Couldn't retrieve the attractor_all for the DS. ");
    // return -1;
  }

  if (!nh.getParam("ds_id", ds_id))  {
    ROS_ERROR("Couldn't retrieve the ds_id. ");
    // return -1;
  }
